...
${OBJECTDIR}/d_mcarlo.o: d_mcarlo.f08
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/d_mcarlo.o d_mcarlo.f08

${OBJECTDIR}/fft_convolve_3d.o: fft_convolve_3d.f08
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/fft_convolve_3d.o fft_convolve_3d.f08

${OBJECTDIR}/input_module.o: input_module.f08
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/input_module.o input_module.f08

${OBJECTDIR}/link_gaze_grid.o: link_gaze_grid.f08
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/link_gaze_grid.o link_gaze_grid.f08

${OBJECTDIR}/lm_exact.o: lm_exact.f08
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/lm_exact.o lm_exact.f08

${OBJECTDIR}/main.o: main.f08
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/main.o main.f08
